    ...
    while (have_posts()):
        ...
        <div class="container">
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <div
                    class="entry-header flex flex-col xs:flex-row gap-5 justify-between items-center text-[22px] md:text-[28px] leading-6 md:leading-8 text-primary font-semibold">
